...
public class InteractiveLogAspect {
     ...
     */
    private static String[] excludePathPatterns = new String[]{"getBrowerToken", "getRandomCode", "login", "sessionError"};
    ...
    private InteractiveLog getInteractiveLog(JoinPoint joinPoint) {
        ...
        interactiveLog.setRequester(user.getNick());
        interactiveLog.setRequesterName(user.getUname());
        interactiveLog.setRequestFrom(user.getLoginIp() + ":" + user.getLoginPort());
